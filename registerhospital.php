...
<body >
    ...
    <div class="login-box">
        ...
        <form method="POST">
            <div class="box"> 
                <div class="input-box">
                    <b>Hospital name: </b><input type="text" name="Hospital_Name" class="input-field"  autocomplete="off" required> <br><br>      
                </div>
                <div class="input-box">
                    <b>Address: </b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="Address" class="input-field"  autocomplete="off" required>    <br><br>   
                </div>
                <div class="input-box">
                    <b>Password: </b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="password" name="Password" class="input-field"  autocomplete="off" required> <br><br><br><br>      
                </div>
                <div class="input-submit">
                    <button class="submit-btn" id="submit" type="submit" name="submit"></button>
